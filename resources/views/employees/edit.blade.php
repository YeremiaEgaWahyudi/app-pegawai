...
<div class="form-container">
    <div class="form-header">
        <h2 class="form-header-title">Edit Data Pegawai</h2>
        <p class="form-subtitle">Perbarui informasi pegawai: {{ $employee->nama_lengkap }}</p>
    </div>
            ...
            <fieldset class="form-section">
                ...
                <div class="form-group">
                    ...
                    <textarea id="alamat" name="alamat" rows="3"
                        ...
                        class="@error('alamat') input-error @enderror">{{ old('alamat', $employee->alamat) }}</textarea>
                    @error('alamat')
                    <span class="error-message">{{ $message }}</span>
                    @enderror
                </div>
